...
module.exports = router => {
  ...
  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit', function (req, res) {
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit', function (req, res) {
    res.redirect(`/main/appeals/${req.params.caseId}/rule-6-parties/${req.params.partyId}/edit/name`)
  })

  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit/name', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
    let party = appeal.rule6Parties.find(party => party.id === req.params.partyId)
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit/name', function (req, res) {
    res.redirect(`/main/appeals/${req.params.caseId}/rule-6-parties/${req.params.partyId}/edit/email-address`)
  })

  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit/email-address', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
    let party = appeal.rule6Parties.find(party => party.id === req.params.partyId)
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit/email-address', function (req, res) {
    res.redirect(`/main/appeals/${req.params.caseId}/rule-6-parties/${req.params.partyId}/edit/phone`)
  })

  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit/phone', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
    let party = appeal.rule6Parties.find(party => party.id === req.params.partyId)
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit/phone', function (req, res) {
    res.redirect(`/main/appeals/${req.params.caseId}/rule-6-parties/${req.params.partyId}/edit/form`)
  })

  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit/form', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit/form', function (req, res) {
    res.redirect(`/main/appeals/${req.params.caseId}/rule-6-parties/${req.params.partyId}/edit/check`)
  })

  router.get('/main/appeals/:caseId/rule-6-parties/:partyId/edit/check', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
    let party = appeal.rule6Parties.find(party => party.id === req.params.partyId)
  ...
  router.post('/main/appeals/:caseId/rule-6-parties/:partyId/edit/check', function (req, res) {
    let appeal = req.session.data.appeals.find(appeal => appeal.id == req.params.caseId)
    let party = appeal.rule6Parties.find(party => party.id === req.params.partyId)
