...
router.post('/edit-hearing-details', function (req, res) {
  res.redirect('/projects/start-s78-case/v1/edit-hearing-details/has-time')
})

router.post('/edit-hearing-details/has-time', function (req, res) {
  if(req.session.data.hearing.hasTime == 'Yes') {
    res.redirect('/projects/start-s78-case/v1/edit-hearing-details/time')
  } else {
    res.redirect('/projects/start-s78-case/v1/edit-hearing-details/has-address')
  }
})
...
router.post('/edit-hearing-details/has-address', function (req, res) {
  if(req.session.data.hearing.hasAddress == 'Yes') {
    res.redirect('/projects/start-s78-case/v1/edit-hearing-details/address')
  } else {
    res.redirect('/projects/start-s78-case/v1/edit-hearing-details/check')
  }
})
